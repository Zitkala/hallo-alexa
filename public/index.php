...
<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
        <div class="p-4 md:p-12 text-center lg:text-left">
            <div class="block lg:hidden shadow-xl mx-auto -mt-16 h-48 w-48 rounded-full"><img src="<?= asset('images/hallo_alexa.jpg') ?>" alt="hallo_alexa_" class="rounded-full"></div>
            ...
            <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between sm:text-center">
